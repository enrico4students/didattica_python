...
for i in range(NUMELE):
    ...
    # il numero di numeri vettori di v[i]

for i in range(NUMELE):
    indice_destinazione = vett_nr_minori[i] # nr di nr minori e' indice della
    # destinazione nel nuovo vettore
    vettoreSort[indice_destinazione] = vettore[i] # banale assegnamento
